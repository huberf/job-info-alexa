...
jobApp.launch(function(request,response) {
  response.say("You can ask me for information about jobs. Try saying, how much do Web Developers earn, or tell me about Medical Workers.").shouldEndSession(false).reprompt("You can ask now.");
});
